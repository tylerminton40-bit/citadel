...
export default function RanksPage() {
  return (
    <div className="min-h-screen bg-[#050508] text-gray-200 overflow-x-hidden">
      ...
      {/* HERO */}
      <section className="relative pt-16 pb-20 sm:pt-24 sm:pb-28 px-4 text-center overflow-hidden">
      ...
      <section className="px-4 pb-20 text-center">
        <div className="max-w-xl mx-auto">
          ...
          <Link
            href="/matches"
            className="inline-block btn-primary px-10 py-4 rounded-xl text-base font-bold glow-orange"
          >
            Start Climbing →
          </Link>
        </div>
